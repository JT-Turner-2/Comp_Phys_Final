...
#plotting!
plt.plot(projgal1[:,0], projgal1[:,1], '.', color='maroon', label='projected')
plt.xscale('log')
plt.ylabel('calibrated flux [10^-17 ergs/s/cm^2/A]')
plt.xlabel('log10(wavelength [A])')
plt.title("Projected Transformed Spectra")
plt.show()

plt.plot(forgal1[:,1], forgal1[:,0], '.', color='coral', label='original')
plt.xscale('log')
plt.ylabel('calibrated flux [10^-17 ergs/s/cm^2/A]')
plt.xlabel('log10(wavelength [A])')
...
plt.plot(projgal2[:,0], projgal2[:,1], '.', color='firebrick', label='projected')
plt.xscale('log')
plt.ylabel('calibrated flux [10^-17 ergs/s/cm^2/A]')
plt.xlabel('log10(wavelength [A])')
plt.title("Projected Transformed Spectra")
...
plt.plot(forgal2[:,1], forgal2[:,0], '.', color='darkorange', label='original')
plt.xscale('log')
plt.ylabel('calibrated flux [10^-17 ergs/s/cm^2/A]')
plt.xlabel('log10(wavelength [A])')
plt.title('Original Spectra')
...
# plt.plot(projgal1[:,0], projgal1[:,1], '.')
# plt.yscale('log')
# plt.show()
#
# plt.plot(projgal1[:,0], projgal1[:,1], '.')
...
plt.plot(np.log(transform_gal1[:,1]), transform_gal1[:,0], '.', color='royalblue')
plt.ylabel('calibrated flux [10^-17 ergs/s/cm^2/A]')
plt.xlabel('log10(wavelength [A])')
plt.title('Transformed Spectra')
plt.show()

plt.plot(np.log(transform_gal2[:,1]), transform_gal2[:,0], '.', color='indigo')
plt.ylabel('calibrated flux [10^-17 ergs/s/cm^2/A]')
plt.xlabel('log10(wavelength [A])')
plt.title('Transformed Spectra')
plt.show()

# plt.plot(transform_gal1[:,1], transform_gal1[:,0], '.')
# plt.yscale('log')
# plt.show()
#
# plt.plot(transform_gal1[:,1], transform_gal1[:,0], '.')
